...
export default function FairProfileClient({ initialFair }) {
  ...
  function FairProductCard({ prod }) {
    ...
    const isVirtualMenu = isVirtualMenuBrand(brandOfProd);
    ...
    if (rawCardText === "brand") {
      titleTextColor = brandOfProd?.color || "var(--gold-primary)";
      priceTextColor = brandOfProd?.color || "var(--gold-primary)";
    ...
    if (rawCardBorder === "brand") {
      cardBgStyle.border = `1.5px solid ${brandOfProd?.color || "var(--gold-primary)"}`;
    ...
    if (isVirtualMenu && !cardBgStyle.border) {
      cardBgStyle.border = "1.5px solid rgba(16, 185, 129, 0.4)";
    }
    ...
    return (
      ...
      >
        <div 
          ...
          style={{ 
            ...
            backgroundColor: (prod.imgBgColor && prod.imgBgColor !== "transparent") 
              ? (prod.imgBgColor === "brand" ? (brandOfProd?.color || "var(--gold-primary)") : prod.imgBgColor)
              : "transparent",
        ...
        <div style={{ padding: "1.2rem", flex: 1, display: "flex", flexDirection: "column", gap: "0.5rem" }}>
          ...
          {brandOfProd && (
            <span style={{ fontSize: "0.75rem", color: isDarkBg ? "#A1A1AA" : "var(--text-muted)", display: "flex", alignItems: "center", gap: "4px" }}>
